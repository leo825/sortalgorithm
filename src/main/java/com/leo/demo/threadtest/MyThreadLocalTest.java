    ...
    public static class MyIntegerTask implements Runnable {
        ...
        public void run() {
            for (int i = 0; i < 5; i++) {
                ...
                if (null == MyThreadLocalTest.threadLocal.get()) {
                    ...
                    System.out.println("线程" + name + ": " + MyThreadLocalTest.threadLocal.get());
                    if (i == 3) {
        ...
        public void run() {
            for (int i = 0; i < 5; i++) {
                if (null == MyThreadLocalTest.threadLocal.get()) {
                    ...
                    String str = (String) MyThreadLocalTest.threadLocal.get();
                    MyThreadLocalTest.threadLocal.set(str + "a");
                    System.out.println("线程" + name + ": " + MyThreadLocalTest.threadLocal.get());
                }
                try {
                    Thread.sleep(800);
