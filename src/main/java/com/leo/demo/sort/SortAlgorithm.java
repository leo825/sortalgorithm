...
//			array[j+1] = temp;
    ...
    /**
     * 交换排序：冒泡排序(在要排序的一组数中，对当前还未排好序的范围内的全部数，自上而下对相邻的两个数依次进行比较和调整，让较大的数往下沉，较小的往上冒。
...
//    }
    ...
    public static void isOddCostTimeTest() {
        long num = 10000L;
        ...
        System.out.println("isOdd1耗时：" + (end1 - stat) + "ms");
        for (long i = 0; i < num; i++) {
            isOdd2(i);
        }
        long end2 = System.currentTimeMillis();
        System.out.println("isOdd2耗时：" + (end2 - end1) + "ms");
    }
